...
function App() {
  ...
  return (
    <div id="app">
      ...
      <h1 className="text-center text-6xl text-"><span className="bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">Vite</span> React Tailwind</h1>
