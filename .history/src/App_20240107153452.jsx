...
function App() {
  ...
  return (
    <div id="app">
      ...
      <h1 className="font-['system-ui'] text-bold text-center text-8xl text-blue-400"><span className="bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">Vite</span> React Tailwind</h1>
      <div className="flex-col">
        ...
        <div className="flex  justify-center align-center gap-4 border-1">
          ...
          >
            <img
              src="https://img.icons8.com/ios/28/minus.png"
              alt="minus"
          ...
          >
            <img
              src="https://img.icons8.com/ios/28/plus.png"
              alt="plus"
              className="mx-auto"
            />
          </button>
