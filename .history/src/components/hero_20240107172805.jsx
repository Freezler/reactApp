...
const Hero = () => {
  return (
    <div className=" mx-auto flex h-screen items-center justify-center flex-col font-[system-ui] bg-gradient-to-bl from-indigo-900 via-indigo to-tertiary w-full">
      <img
