...
const Hero = () => {
  return (
    <div className="mx-auto flex items-center justify-center flex-col font-sans h-screen bg-gradient-to-bl from-indigo-900 via-indigo-800 to-opal-700 w-full">
      <img
