...
const Hero = () => {
  return (
    <div className=" mx-auto flex h-screen items-center justify-center flex-col font-[system-ui] bg-gradient-to-bl from-indigo-900 via-indigo-800 to-indigo-700  w-full">
      <img
      ...
      <div className="text-center lg:w-5/12 w-full">
        <h1 className=" text-white my-4 text-5xl font-bold leading-tight text-pretty">
          My first react app
        </h1>
        <p className="text-2xl mb-8 text-kobalt-100 font-bold leading-relaxed text-blue-100">
