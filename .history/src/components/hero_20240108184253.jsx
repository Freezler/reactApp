...
const Hero = () => {
  return (
    <div className="mx-auto flex items-center justify-center flex-col font-sans h-screen bg-gradient-to-l from-indigo-900 via-indigo-800 to-indigo-300 w-full">
      <img
