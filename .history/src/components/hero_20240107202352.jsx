...
const Hero = () => {
  return (
    <div className="mx-auto flex items-center justify-center flex-col font-sans h-screen bg-gradient-to-bl from-indigo-900 via-indigo-800 to-indigo-700 w-full">
      <img
      ...
      <div className="text-center w-11/12 md:w-5/12">
        ...
        <div className="flex justify-center mx-auto">
          <button type="button" className="hover:underline bg-white text-gray-800 font-bold rounded-full py-4 px-8">
            View Projects
          </button>
