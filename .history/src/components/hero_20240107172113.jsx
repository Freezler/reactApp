...
const Hero = () => {
  return (
    <div className=" mx-auto flex h-screen items-center justify-center flex-col font-[system-ui] bg-gradient-to-bl from-primary to-secondary to-tertiary w-full">
      <img
