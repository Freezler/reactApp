...
function App() {
  ...
  return (
    <div id="app">
      ...
      <h1 className="font-['system-ui'] text-bold text-center text-xl text-blue-400"><span className="bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">Vite</span> React Tailwind</h1>
